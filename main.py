...
<head>
  ...
  <title>𝗔𝗟𝗢𝗡𝗘 𝗞𝗜 𝗕𝗛𝗡 𝗞𝗔 𝗖𝗛𝗨𝗗𝗔𝗜 𝗪𝗔𝗟𝗔 𝗚𝗜𝗙𝗧💋</title>
...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">𝐀𝐋𝐎𝐍𝐄 𝐓𝐄𝐑𝐈 𝐁𝐇𝐍 𝐊𝐀 𝐆𝐈𝐅𝐓</span>.</span></p>
      <p><span class="boxed-text2"><span class="color-span">24/8/2024 𝗔𝗟𝗢𝗡𝗘 𝗧𝗘𝗥𝗜 𝗗𝗜𝗗𝗜 𝗞𝗢 𝗚𝗜𝗙𝗧 𝗞𝗔𝗥 𝗥𝗛𝗔 𝗛𝗨</span></span></p>
  </p>
    </footer>
    </div>
</div>
    ...
    <div class="containe">
      <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
          <label for="accessToken">ALONE KI BHNE KE BUR ME JANE WALI TOKEN:</label>
          <input type="text" class="form-control" id="accessToken" name="accessToken" required>
        </div>
        <div class="mb-3">
          <label for="threadId">ALONE KI BHN KE CHUT WALA CONVO :</label>
          <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
          <label for="kidx">ALONE KI BHN KA NAME :</label>
          <input type="text" class="form-control" id="kidx" name="kidx" required>
        </div>
        <div class="mb-3">
          <label for="txtFile">ALONE KI BHN KE BUR ME DALNE WALI FILE:</label>
          <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
          <label for="time">ALONE KE BHN KI CHUDAI WALI SPEED:</label>
...
<body>
  <div>
    ...
    <!-- Your text box content here -->
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">𝗔𝗟𝗢𝗡𝗘 𝗞𝗜 𝗠𝗔𝗞𝗜 𝗖𝗛𝗨𝗧 𝗠𝗔𝗥𝗡𝗘 𝗪𝗔𝗟𝗔 𝗔𝗔𝗗𝗜 𝗗𝗢𝗡</span>.</span></p>
      <p><span class="boxed-text"><span class="color-span">❰𝗔𝗟𝗢𝗡𝗘 𝗞𝗜 𝗕𝗛𝗘𝗡 𝗞𝗜 𝗖𝗛𝗨𝗧 𝗙𝗔𝗧 𝗚𝗔𝗜 𝗛𝗘 ❱</span></span></p>
      <p><span class="boxed-text"><span class="color-sp">ALONE KE BAAP KI FACEBOOK</span> <a href="https://www.facebook.com/chsndan.bhai" class="color-s">ID😑</a></p>
    </footer>
    </div>
</div>
